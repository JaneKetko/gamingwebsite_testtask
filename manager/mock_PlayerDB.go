...
func (_m *MockPlayerDB) AddPlayer(ctx context.Context, name string) (int, error) {
...
func (_m *MockPlayerDB) DeletePlayer(ctx context.Context, id int) error {
...
func (_m *MockPlayerDB) PlayerByID(ctx context.Context, id int) (*player.Player, error) {
	ret := _m.Called(ctx, id)
...
func (_m *MockPlayerDB) UpdatePlayer(ctx context.Context, id int, _a2 player.Player) error {
